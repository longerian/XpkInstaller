...
import me.longerian.installer.XpkInstaller;


public class AppChinaPackage extends AppPackage {

	public AppChinaPackage(String path) {
		this.packagePath = path;
		this.packageInstaller = new XpkInstaller();
	}
	...
	protected boolean isValid() {
		...
		if(packagePath != null) {
			...
			if(!apkFile.exists() || apkFile.isDirectory() || !apkFile.getName().endsWith(".xpk")) {
